...
export default function App() {
  ...
  const renderHandoff = () => {
    ...
    const jotformUrl = `https://form.jotform.com/260667434445159?totalAmount=${cartTotal}&paymentAmount=${cartTotal}&servicesOrdered=${serviceList}&storecode=${encodeURIComponent(savedStoreCode)}&customernotes=${notes}`;
  ...
  return (
    ...
    >
      {step === 'landing' && (
        <StoreSettings 
          onUpdate={({ storeCode, brightness, volume }) => {
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex justify-between items-center">
                          <div className="space-y-1">
                            ...
                            <p className="text-[10px] text-zinc-600 leading-tight uppercase font-black tracking-widest">M2M shipping waived when bundled with other services</p>
                          </div>
                          <span className="text-2xl font-black text-white">
