...
export const SERVICE_COPY: Record<string, { description: string; details: string }> = {
  ...
  "BGS Express": { description: "Beckett grading with full subgrades and their premium label. Every card submitted through Market 2 Mint receives a careful wipe-down and is securely processed from start to finish.", details: "" },
  "BGS Express w/Auto": { description: "Beckett grading with full subgrades and their premium label. Every card submitted through Market 2 Mint receives a careful wipe-down and is securely processed from start to finish.", details: "Only pack-pulled autograph cards can be submitted. All autographs are graded by BGS, but only 10's make it to the label." },
  "BGS Priority": { description: "The same Beckett grading and premium label as Express, back roughly ten business days sooner. Every card submitted through Market 2 Mint receives a careful wipe-down and is securely processed from start to finish.", details: "" },
  "BGS Priority w/Auto": { description: "The same Beckett grading and premium label as Express, back roughly ten business days sooner. Every card submitted through Market 2 Mint receives a careful wipe-down and is securely processed from start to finish.", details: "Only pack-pulled autograph cards can be submitted. All autographs are graded by BGS, but only 10's make it to the label." },
